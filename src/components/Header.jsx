...
export default function Header() {
  ...
  return (
    <div className="fixed glass backdrop-brightness-50 top-0 left-0 right-0 w-full z-50">
      <header className="   text-white container mx-auto  py-4 items-center">
        <div className="grid grid-cols-3 items-center gap-4 ">
          ...
          <Link
            ...
            } font-semibold items-center flex justify-center `}
          >
            Home
          </Link>

          <div className="flex items-center gap-4 relative text-xl justify-end">
